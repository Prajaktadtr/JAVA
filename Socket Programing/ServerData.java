...
import java.io.File;
import java.io.*;
class ServerData extends JFrame implements Runnable,ActionListener
{
     File file;
	...
	int cport=10,sport=11;
      ...
      ServerData(String title) throws Exception
          {
                    ...
                    if(evt.getSource()==selectFile)
                    {
                         ...
                         try
                         {
                              ...
                              //read all tha data inside the file
                                   ...
                                   dp=new DatagramPacket(message.getBytes(),message.length(),InetAddress.getLocalHost(),cport);
